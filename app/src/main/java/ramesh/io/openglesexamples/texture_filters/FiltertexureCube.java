...
import ramesh.io.openglesexamples.R;

/**
 * Created by Ramesh Bhupathi on 29/08/18.
 */
public class FiltertexureCube {
    ...
    public void loadTexture(GL10 gl, Context context) {
        ...
        InputStream istream = context.getResources().openRawResource(+R.drawable.android_launcher);
        Bitmap bitmap;
        try {
