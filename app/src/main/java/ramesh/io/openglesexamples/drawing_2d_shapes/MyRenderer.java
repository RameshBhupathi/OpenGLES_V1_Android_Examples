...
import ramesh.io.openglesexamples.drawing_2d_shapes.shapes.Square;
import ramesh.io.openglesexamples.drawing_2d_shapes.shapes.Triangle;
...
public class MyRenderer implements GLSurfaceView.Renderer {
    ...
    public void onDrawFrame(GL10 gl10) {
        ...
        gl10.glTranslatef(-1.5f, 0.0f, -6.0f); // Translate left and into the screen ( NEW )
